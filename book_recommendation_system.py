...
#     st.image('header_image.jpeg', use_column_width=True)
#     st.write('Welcome to the Book Recommendation System! Use the sidebar to navigate.')
...
#     st.title('User-Book Matrix Heatmap')
#     # Load data
#     book_df, ratings_df, user_df = load_data()
...
# if page == 'Home':
#     st.markdown("<div class='center-content'><h1>📚 Book Recommendation System</h1></div>", unsafe_allow_html=True)
#     st.markdown("<div class='center-content'><img src='header_image.jpeg' width='500'/></div>", unsafe_allow_html=True)
